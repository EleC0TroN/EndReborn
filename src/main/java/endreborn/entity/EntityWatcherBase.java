...
public class EntityWatcherBase extends EntityMob
{
    ...
    private static final DataParameter<Optional<IBlockState>> CARRIED_BLOCK = EntityDataManager.<Optional<IBlockState>>createKey(EntityWatcherBase.class, DataSerializers.OPTIONAL_BLOCK_STATE);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(10, new EntityWatcherBase.AIPlaceBlock(this));
        this.tasks.addTask(11, new EntityWatcherBase.AITakeBlock(this));
    ...
    static class AIPlaceBlock extends EntityAIBase
        {
            ...
            public AIPlaceBlock(EntityWatcherBase p_i45843_1_)
            {
    ...
    static class AITakeBlock extends EntityAIBase
        {
            ...
            public AITakeBlock(EntityWatcherBase p_i45841_1_)
            {
            ...
            public void updateTask()
            {
                ...
                if (EntityWatcherBase.CARRIABLE_BLOCKS.contains(block) && flag)
                {
