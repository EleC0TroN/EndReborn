...
public class EntityEGuard extends EntityMob
{
    ...
    public EntityEGuard(World worldIn)
    {
        super(worldIn);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityEGuard.class);
    }

    protected void initEntityAI()
    {
        this.tasks.addTask(4, new EntityEGuard.AIFireballAttack(this));
    ...
    static class AIFireballAttack extends EntityAIBase
        {
            private final EntityEGuard blaze;
            private int attackStep;
            private int attackTime;

            public AIFireballAttack(EntityEGuard blazeIn)
            {
                this.blaze = blazeIn;
                this.setMutexBits(6);
            }
